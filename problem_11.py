...
def main(grid, n):
    '''
    Find the greatest product of n adjacent numbers in a two dimensional array

    Args:
        grid: a two dimensional array of integers
        n: the number of adjacent numbers for which to calculate a product
